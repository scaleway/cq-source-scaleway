module github.com/scaleway/cq-source-scaleway
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/licensemanager v1.34.1 // indirect
	github.com/aws/aws-sdk-go-v2/service/marketplacemetering v1.31.0 // indirect
